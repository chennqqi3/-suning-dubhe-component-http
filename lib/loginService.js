    ...
    app.service("LoginService", ['baseUrl', function (baseUrl) {
        ...
        function logout() {
            ...
            if (location.hostname.match('sit')) {
                location.href = 'http://ssosit.cnsuning.com/ids/logout?service=' + encodeURIComponent(location.href)
            } else if (location.hostname.match('pre')) {
                location.href = 'http://ssopre.cnsuning.com/ids/logout?service=' + encodeURIComponent(location.href)
            } else {
